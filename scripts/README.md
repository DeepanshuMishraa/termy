...
- `check-boundaries.sh`: validates crate dependency boundaries, dependency license policy, generated docs, required ownership docs, release packaging path alignment, and Rust file size limits (via `check-file-sizes.sh`).
