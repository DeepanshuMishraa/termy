    ...
    <HomeLayout {...baseOptions()}>
      <main className="flex flex-1 flex-col">
        <section className="mx-auto w-full max-w-6xl px-6 pt-28 pb-16 md:pt-32 lg:pb-20">
          <div className="grid items-start gap-12 lg:grid-cols-[minmax(0,20rem)_minmax(0,1fr)] lg:gap-14">
            <div className="lg:pt-2">
              <p className="font-mono text-xs text-fd-muted-foreground">
                <span className="select-none text-fd-foreground">$ </span>
                termy
              </p>
              <h1 className="mt-6 text-balance font-medium text-5xl tracking-tight md:text-6xl">
                A fast, native terminal.
              </h1>
              <p className="mt-6 text-balance text-fd-muted-foreground md:text-lg">
            ...
            <figure className="overflow-hidden rounded-lg border border-fd-border">
              <img
                src={landingScreenshot}
                alt="Termy on macOS with appearance settings"
                width={3007}
                height={1894}
                loading="eager"
                decoding="async"
        ...
        <section className="mx-auto w-full max-w-3xl px-6 pb-24">
          <div className="border-t border-fd-border pt-10">
              ...
              <div className="divide-y divide-fd-border">
                {sponsors.map((sponsor) => (
                  ...
                  >
                    ...
                    <span
                      aria-hidden
                      className="ml-auto shrink-0 text-fd-muted-foreground transition-colors group-hover:text-fd-foreground"
                    >
                      ↗
                    </span>
                  </a>
